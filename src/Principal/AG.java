...
public class AG {
	public static void executarAG(ArrayList<Cromossomo> lc, ArrayList<Preferencia> lp, Populacao p) {
	...
	public static void executarAGcomMascara(ArrayList<Cromossomo> lc, ArrayList<Preferencia> lp, Populacao p) {
		CriteriosParada criterio = new ParadaTodosCriterios();
		ValoresDeParada valoresDeParada = new ValoresDeParada();
		///variaveis de controle /////
		int contClones = 0, contMutacoes = 0;
